            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        <img src="{{ url('storage/user').'/'.auth()->user()->image }}" alt="{{ auth()->user()->name }}" class="rounded-circle">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="{{ url('/web/consolute') }}">
                                <i class="ri-heart-pulse-line"></i>
                                <span>Medical Consultaions</span>
                            </a>
                        </li>
                        <li>
                            <hr class="dropdown-divider">
                        ...
                        @endauth
                        @guest
                        <a class="nav-link nav-profile d-flex align-items-center" href="{{ route('login') }}" >
  ...
  crossorigin="anonymous"></script>
    ...
    $.ajax({
        ...
        success: function(data) {
            id= new URL(window.location.href).searchParams.get('category_id');
            if(id != null){
            ...
            data.results.forEach(element => {
                ...
                link="{{ url('/') }}"+'/?category_id='+element.id;
                list =  '<li class="nav-item" role="presentation">'+
                        '<a href="'+link+'" class="nav-link'+active+'" id="category'+element.id+'"  type="button" aria-selected="false">'+element.text+'</a>'+
                        '</li>';
                $('#borderedTab').append(list);
            });
        },
        type: 'GET'
     });
